...
oocsAppModule.controller('ScanController', ['$scope', '$state', 'ScanService',
...
oocsAppModule.controller('ScanDetailController', ['$scope', '$state', 'ScanDetailService',
    function($scope, $state, ScanDetailService) {
        'use strict';
        var dispatchJSONdata = function() {
            ...
            ScanDetailService.getJSONdata(0)
            .then(
                function(response) {
